...
function X(a) {
    var b = this;
    this.status = M.PARSEC_NOT_RUNNING;
    ...
    this.l.imageSmoothingEnabled = !0;
    this.l.Z = "high";
    this.u = [];
    this.s = {};
    this.v = 0;
    ...
    this.i = this.g = null;
    this.B.push(
        N(window, "beforeunload", function () {
            b.D();
            return null;
        })
    );
...
function Z(a, b) {
    b != M.PARSEC_OK &&
        (a.b && a.status == M.PARSEC_OK && a.b.send(P(10, 0, 0, 0), 0),
...
h.P = function (a) {
    ...
    return L(function (l) {
        if (1 == l.b) {
            ...
            if (!d) return (b.status = M.PARSEC_WRN_BROWSER), l.return(null);
            if (b.status != M.PARSEC_NOT_RUNNING) return l.return(null);
            b.status = M.PARSEC_CONNECTING;
            R = {};
            S = 1;
            na(b);
            Y(b);
            ...
            g = function () {
                b.B.push(
                    N(document, "visibilitychange", function () {
                        document.hidden
...
h.I = function (a, b, d, f, g) {
    this.j == a && this.b && la(this.b, d, f, g);
};
h.H = function (a, b, d, f, g) {
...
h.U = function (a, b) {
    this.b && this.status == M.PARSEC_OK && this.b.send(Q(17, a, b), 0);
};
h.T = function (a) {
    this.b &&
        this.status == M.PARSEC_OK &&
        this.b.send(
            fa(
                a,
                this.f.frameWidth,
...
h.O = function () {
    return this.status == M.PARSEC_OK && 5e3 < performance.now() - this.G;
};
h.R = function () {
    return this.o.shift();
};
X.prototype.destroy = X.prototype.D;
X.prototype.getBufferSize = X.prototype.X;
X.prototype.getBuffer = X.prototype.W;
X.prototype.clientNewAttempt = X.prototype.P;
X.prototype.clientBeginP2P = X.prototype.I;
X.prototype.clientAddCandidate = X.prototype.H;
X.prototype.clientGetStatus = X.prototype.N;
X.prototype.clientGetSelf = X.prototype.M;
X.prototype.clientGetHostMode = X.prototype.K;
X.prototype.clientGetGuests = X.prototype.J;
X.prototype.clientDisconnect = X.prototype.C;
X.prototype.clientSendUserData = X.prototype.U;
X.prototype.clientSendMessage = X.prototype.T;
X.prototype.clientPollEvents = X.prototype.S;
X.prototype.clientGetMetrics = X.prototype.L;
X.prototype.clientNetworkFailure = X.prototype.O;
X.prototype.clientPollAudio = X.prototype.R;
X.prototype.Status = M;
window.Parsec = X;
